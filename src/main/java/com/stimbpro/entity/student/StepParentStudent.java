package com.stimbpro.entity.student;
...
@Entity
public class StepParentStudent implements Serializable  
{
	...
	public StepParentStudent()
	{
		
	}
	
	public StepParentStudent(String fatherName, String fatherStatus,
